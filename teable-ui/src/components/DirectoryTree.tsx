...
interface DirectoryTreeProps {
  ...
  onCreateTable?: () => void; // 创建表格回调
  items?: string[];
  headerLeft?: ReactNode; // 自定义头部左侧内容（用于放置 Space/Base 选择器等）
}
...
export const DirectoryTree = ({ onFileOpen, onFileCreate, onFileDelete, onCreateTable, items, headerLeft }: DirectoryTreeProps) => {
